...
namespace umamusumeKeyCtl.Util
{
    ...
    {
        //User32 wrappers cover API's used for VirtualMouse input
        #region User32
    ...
    /// <code>
    /**
        VirtualMouse.MoveTo(new Point(100, 100));
    ...
    */
    ...
    /// <code>
    /**
            VirtualKeyboard.Type("Hello world");
            VirtualKeyboard.Press(Key.LeftShift);
            VirtualKeyboard.Type("hello, capitalized world");
            VirtualKeyboard.Release(Key.LeftShift);
    */
    /// </code>
    /// </example>
